	...
	<c:forEach var="LastOrderInfo" items="${list_OrderVO}">
		...
		<div id="stg3_1_SetPizza_basic" style="display: none;"
			...
			<a href="/user/Stg3_1_2_SetAddress_deliver0/${principal.username}"
				...
				role="button" id="btn_stg3_1_1_visitStore">방문 하실 매장은
				${LastOrderInfo.storeName} 입니다.</a> <a
				href="/user/Stg3_1_1_SetAddress_deliver1/${principal.username}"
				class="btn btn-primary btn-lg btn-block" style="display: none;"
				role="button" id="btn_stg3_1_1_orderDeliver">지난번 배송지는 [
				${LastOrderInfo.orderAddress} ] 였어요. 여기로 재배송할게요~! (변경하려면 클릭!)</a>


			<button type="button" class="btn btn-primary btn-lg btn-block"
				value="order_request">요청사항은
				${LastOrderInfo.orderRequest}입니다.</button>
			<button type="button" class="btn btn-primary btn-lg btn-block"
				value="order_payment">결재수단</button>
			<button type="button" class="btn btn-primary btn-lg btn-block"
				value="order_receipt">현금영수증</button>
			<button type="button" class="btn btn-primary btn-lg btn-block"
				value="order_required_time">예상시간</button>
			<button type="button" class="btn btn-default btn-lg btn-block"
				value="order_list_price">최종금액</button>
			<button type="button" class="btn btn-primary btn-lg btn-block"
				value="order_commend">주문하기</button>
